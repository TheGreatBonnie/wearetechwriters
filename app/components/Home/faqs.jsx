    ...
    <>
      ...
      <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
          <h2 class="text-2xl font-bold md:text-3xl md:leading-tight text-gray-800 dark:text-gray-200 bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent">
        ...
        <div class="max-w-5xl mx-auto">
          ...
          <div class="grid sm:grid-cols-2 gap-6 md:gap-12">
            ...
            <div>
              ...
              <p class="mt-2 text-gray-600 dark:text-gray-400">
                Weve built in discounts at each tier for teams. The time has
