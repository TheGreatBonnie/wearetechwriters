  ...
  return (
    ...
    <>
      <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="text-center font-bold text-gray-800 text-2xl md:text-3xl lg:text-4xl bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent">
          Why Work With Us?
        </div>
