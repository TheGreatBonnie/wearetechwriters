      ...
      <div class="max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
          <div class="col-span-full lg:col-span-1">
            {/* <a
              class="flex-none text-xl font-semibold text-gray-800"
              href="#"
              aria-label="Brand">
              WeAreTechWriters
            </a> */}
          ...
          <div class="col-span-1">
            <h4 class="font-semibold text-gray-800">Product</h4>

            <div class="mt-3 grid space-y-3">
              <p>
                <Link href="/services" legacyBehavior>
                  <a
                    class="inline-flex gap-x-2 text-gray-600 hover:text-gray-200"
                    href="#">
                    Our Services
                  </a>
                </Link>
          ...
          <div class="col-span-2">
            ...
            <form>
              <div class="mt-4 flex flex-col items-center gap-2 border shadow-lg shadow-gray-100 sm:flex-row sm:gap-3 bg-white rounded-md p-2">
                <div class="w-full">
        ...
        <div class="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
          <div class="flex justify-between items-center">
            <p class="text-sm text-gray-600">
              © 2023 WeAreTechWriters. All rights reserved.
            </p>
          </div>
          {/* <!-- End Col --> */}
          ...
          <div>
            <a
              class="inline-flex justify-center items-center gap-x-3.5 w-10 h-10 text-center text-gray-600 hover:bg-white/[.1] rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-gray-900 transition"
              href="#">
              <svg
                class="w-4 h-4"
